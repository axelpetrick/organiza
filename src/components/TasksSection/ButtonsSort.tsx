...
const sortValues = [
  { value: "order-added", title: "Ultimos Adicionados" },
  { value: "min-date", title: "Data Crescente" },
  { value: "max-date", title: "Data Decrescente" },
  { value: "completed-first", title: "Completos" },
  { value: "uncompleted-first", title: "Incompletos" },
];
